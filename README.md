...
想更深入地理解系统机制与设计取舍，建议按下面的顺序阅读：

| 文档 | 内容 | 适合 |
|---|---|---|
| 📖 [案例详解](docs/system-walkthrough.md) | 用一次真实运行走通生产 + 自进化两条链路，输入 / 评分 / 补丁均可复核 | 想看系统端到端实际怎么跑 |
| 🧭 [设计与方法论](docs/vip-copy-workshop.md) | 个性化与可进化两个核心能力的问题重定义和设计动机 | 想理解「为什么这么设计」 |
| 🏗️ [架构说明](docs/design.md) | 运行时形态、不变量、代码地图与产物布局 | 想对照代码读架构 |
| 📐 [评分标准](docs/rubrics.md) | 文案、因子、落表、工程与证据的准入标准 | 想了解质量判定细则 |
| 🛠️ [Skill 方法论](docs/methodology.md) | 生产 / 进化 skill 的写作规范 | 想自己改写 skill |

面向维护者的完整文档索引见 [`docs/README.md`](docs/README.md)。
